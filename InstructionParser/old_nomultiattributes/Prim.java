...
public class Prim {
	...
	private WMERef address1,	// The ID reference for arg1
	 ...
	 */
	public Prim(PrimType type, WMERef address1, String attr1, WMERef address2, String attr2) {
		this.type = type;
	...
	public String toString() {
		...
		retval += "\r\n\t^attr1 " + attr1;
		retval += "\r\n\t^address1 " + address1.getAddress().getVarName();
		if (address2 != null) {
			retval += "\r\n\t^attr2 " + attr2;
			retval += "\r\n\t^address2 " + address2.getAddress().getVarName();
		}
